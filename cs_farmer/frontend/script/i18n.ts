...
const german: Record<string, string> = {
  ...
  "Add new editor": "Neuen Editor hinzufügen",
  "Delete": "Löschen",
  ...
  "Buy seeds using a non-negative whole number or numeric getter as the quantity.":
    "Kaufe Samen mit einer nicht negativen ganzen Zahl oder einem numerischen Getter als Menge.",
  "Sell harvested plants using a non-negative whole number or numeric getter as the quantity.":
    "Verkaufe geerntete Pflanzen mit einer nicht negativen ganzen Zahl oder einem numerischen Getter als Menge.",
  ...
  "Run the indented block once. Conditions support numeric comparisons and string equality checks.":
    "Führt den eingerückten Block einmal aus. Bedingungen unterstützen Zahlenvergleiche und Gleichheitsprüfungen für Texte.",
  ...
  "Repeat the indented block a fixed number of times. The loop name cannot be used inside the block yet.":
    "Wiederholt den eingerückten Block eine feste Anzahl von Malen. Der Schleifenname kann im Block noch nicht verwendet werden.",
  "Exit the nearest while or for loop.":
    "Beendet die nächste umschließende while- oder for-Schleife.",
  ...
  "One statement per line. Tab inserts four spaces; Shift+Tab removes indentation. Press Escape then Tab to leave the editor. Commands and loop/if checks each pause for 500 ms.":
    "Eine Anweisung pro Zeile. Tab fügt vier Leerzeichen ein; Umschalt+Tab entfernt die Einrückung. Mit Escape und anschließend Tab verlässt du den Editor. Befehle und Schleifen-/if-Prüfungen pausieren jeweils 500 ms.",
