...
Deno.test("German translations preserve umlauts and sharp s", () => {
  ...
  strictEqual(translate("Skip the indented block.", "de"), "\u00dcberspringt den einger\u00fcckten Block.");
  const help = translate("One statement per line. Tab inserts four spaces; Shift+Tab removes indentation. Press Escape then Tab to leave the editor. Commands and while/if checks each pause for 500 ms.", "de");
